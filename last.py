...
RPC.connect()
genre_blacklist = ["seen live", "soundtrack", "female vocalists","nsbm","instrumental","composer","video game music","robertitus global","boner inducing","takeshi kobayashi", "silent hill", "za rus v rot ebus", "underground", "usa","anime"]
